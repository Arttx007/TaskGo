...
/**
 * Configura a cadeia de segurança da API: autenticação stateless via JWT (sem sessão, sem CSRF),
 * CORS liberado para o frontend estático, e as regras de acesso por rota.
 */
@Configuration
@EnableWebSecurity
